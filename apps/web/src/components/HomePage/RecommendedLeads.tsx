...
export function RecommendedLeads({ onSelect }: RecommendedLeadsProps) {
  return (
    <div className="w-full">
      {/* Header */}
      <div className="flex items-center justify-center gap-2 py-3 md:px-5 px-0 md:mb-[20px] mb-[10px]">
        <Star className="h-4 w-4 text-[#E5A800] fill-[#E5A800]" />
        <span className="text-white md:text-[18px] text-[16px] leading-[140%] font-noto-sans font-medium tracking-wide">
      ...
      <div className="divide-y divide-white/10">
        {RECOMMENDED_LEADS.map(({ category, jobTitle }) => (
          <button
            ...
            className="w-full flex items-center justify-between md:px-5 px-3 md:py-3 py-2 bg-[#FFFFFF]/20 hover:bg-[#FFFFFF]/30 border border-[#EEEEEA]/50 hover:scale-[1.02] transition-all cursor-pointer group text-left rounded-[10px] mb-[10px]"
          >
            <span className="text-white font-noto-sans lg:text-[18px] md:text-[16px] text-[14px]">
